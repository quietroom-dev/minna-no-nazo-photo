...
<span id="sad-${photoId}" style="white-space:nowrap;"><span style="font-size:10px; margin-left:-3px;">😢</span><small style="font-size:5px;">×</small><span style="font-size:7px;">${photo.sad}</span></span>
<span id="angry-${photoId}" style="white-space:nowrap;"><span style="font-size:10px; margin-left:-3px;">😡</span><small style="font-size:5px;">×</small><span style="font-size:7px;">${photo.angry}</span></span>
<span id="mystery-${photoId}" style="white-space:nowrap;"><span style="font-size:10px; margin-left:-3px;">❓</span><small style="font-size:5px;">×</small><span style="font-size:7px;">${photo.mystery}</span></span>
