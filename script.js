...
<span id="like-${photoId}" style="white-space:nowrap;"><span style="font-size:12px;">👍</span><small style="font-size:5px;">×</small><span style="font-size:9px;">${photo.like}</span></span>
<span id="happy-${photoId}" style="white-space:nowrap;"><span style="font-size:12px;">😆</span><small style="font-size:5px;">×</small><span style="font-size:9px;">${photo.happy}</span></span>
<span id="sad-${photoId}" style="white-space:nowrap;"><span style="font-size:12px;">😢</span><small style="font-size:5px;">×</small><span style="font-size:9px;">${photo.sad}</span></span>
<span id="angry-${photoId}" style="white-space:nowrap;"><span style="font-size:12px;">😡</span><small style="font-size:5px;">×</small><span style="font-size:9px;">${photo.angry}</span></span>
<span id="mystery-${photoId}" style="white-space:nowrap;"><span style="font-size:12px;">❓</span><small style="font-size:5px;">×</small><span style="font-size:9px;">${photo.mystery}</span></span>
...
async function pushStamp(photoId, type, emoji){
    ...
    if(target){
        ...
        target.innerHTML =
`<span style="font-size:12px;">${emoji}</span><small style="font-size:5px;">×</small><span style="font-size:9px;">${current}</span>`;
